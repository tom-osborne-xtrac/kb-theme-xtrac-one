...
function _s_entry_footer() {
	...
	if ( 'post' || 'xt_report' || 'guide' === get_post_type() ) {
		...
		if ( $tags_list ) {
			printf( '<span class="tags-links">' . esc_html__( '%1$s', '_s' ) . '</span>', $tags_list ); // WPCS: XSS OK.
		}
	}
	
	/* TO 05/09/18 comments turned off */
